import{_ as e,o as i,c as a,a as d}from"./app-b935cb82.js";const n={},s=d(`<h3 id="linux-命令课上案例" tabindex="-1"><a class="header-anchor" href="#linux-命令课上案例" aria-hidden="true">#</a> Linux 命令课上案例</h3><h4 id="案例1-ls-pwd-cd-touch-mkdir-cp-mv-rm" tabindex="-1"><a class="header-anchor" href="#案例1-ls-pwd-cd-touch-mkdir-cp-mv-rm" aria-hidden="true">#</a> 案例1: ls/pwd/cd/touch/mkdir/cp/mv/rm</h4><div class="language-yacas line-numbers-mode" data-ext="yacas"><pre class="language-yacas"><code>在桌面上打开终端窗口, 执行如下操作:
01.查看当前路径位置
02.查看当前目录下有哪些文件和文件夹
